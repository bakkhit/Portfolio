...
export default function AboutMe() {
    return (
        <div  id="aboutMe" className="aboutMe flex items-center justify-center text-center h-[100vh]">
            <div className="relative w-150 overflow-hidden">
                ...
                <div className="khitShadow absolute bottom-0 left-0 w-full bg-gradient-to-t from-black to-transparent"></div>
            </div>

            <div className="textAM flex flex-col items-center justify-center w-[50vw] h-fit translate-y-[-50%]">
                <p className="salut text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-purple-500 text-[2vw]">Salut !</p><br></br>
                <p className="textAm text-white max-w-2xl text-[1vw] w-[40vw]">
