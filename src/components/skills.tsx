...
export default function Skills() {
    return (
        <div id="skills" className="flex flex-col w-full items-center justify-center h-[110vh] hover:text cursor-default">
            ...
            <div className="w-fit">
                ...
                <div className="flex w-fit justify-self-center gap-[3vw] flex-wrap">
                    <div className="w-[7vw] h-[7vw] bg-white p-[1vw] flex justify-center items-center rounded-xl group relative overflow-hidden">
